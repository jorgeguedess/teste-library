...
var IconTable = function (props) {
    return (<svg aria-label="Tabela" role="img" {...props} className={(0, tailwind_merge_1.twMerge)("size-5", props.className)} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
